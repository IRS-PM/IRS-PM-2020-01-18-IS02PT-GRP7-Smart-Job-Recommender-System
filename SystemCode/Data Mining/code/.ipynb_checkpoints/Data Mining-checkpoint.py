...
def stop_word_fil(df):
    ...
    print('Number of words before filter:', word_count(df['Requirements']))
    ...
    print('Number of words after filter:', word_count(df['Requirements']))
...
def save_file(df, output_path):
    ...
    df.to_csv('{}JobDatas.csv'.format(output_path), index=False, encoding='utf-8')
    print('File saved')
...
def main():
    ...
    output_path1 = "../output/" #result output
    output_path = "../../../Database/" #database output path
    ...
    print('*************************************************************')
    print('*                                                           *')
    print('*            NUS ISS Group 7 Data Mining Program            *')
    print('*                                                           *')
    print('*************************************************************')
    print('\n')  
    ...
    print('Salary feature: Complete')
    df1 = emp_type(df1)
    df1 = clean_kie(df1)
    df1 = job_edu_cat(df1, cat_list, edu_list)
    df1 = skill_cat(df1, skills_list)
    print('Skills and qualification extraction: Complete')
